...
import '../../pages/financialofficer/OfficerApplications.css'; 

// ==========================================
// EXTRACTED DOCUMENT PREVIEW FUNCTIONALITY
// ==========================================
...
const CitizenSearchPage = () => {
  // Core Profile Search State
  const [searchId, setSearchId] = useState('');
  const [citizenData, setCitizenData] = useState(null);
  const [loading, setLoading] = useState(false);
  const [error, setError] = useState('');

  // Extracted Preview Functionality State
  const [selectedDocumentType, setSelectedDocumentType] = useState('');

  // Extracted Hook/Logic Effect: Syncs drop-down values when lookup profiles flip
  useEffect(() => {
    if (!citizenData) {
  ...
  // Extracted Action: Trigger redirect pipeline to download service on Port 9091
  ...
  // ==========================================
  // PROFILE DATA FETCH FUNCTIONALITY
  // ==========================================
              ...
              <div className="details-section">
                ...
                <div style={{display: 'flex', flexDirection: 'column', gap: '1.2rem'}}>
                  ...
                  <div style={{marginTop: '10px', padding: '15px', background: '#f8fafc', borderRadius: '8px', border: '1px dashed #cbd5e1'}}>
                    ...
                    {/* Render Actions if documents are found */}
                    {citizenData.documents && citizenData.documents.length > 0 && (
